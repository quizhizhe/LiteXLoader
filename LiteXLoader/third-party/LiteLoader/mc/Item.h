...
class ItemStackBase {
  ...
  public:
    ...
    MCINLINE void setCustomName(class std::basic_string<char,
                                                        struct std::char_traits<char>,
                                                        class std::allocator<char>> const &a0) {
        void (ItemStackBase::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                          class std::allocator<char>> const &);
        *((void **)&rv) = dlsym(
            "?setCustomName@ItemStackBase@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE bool updateComponent(class std::basic_string<char,
                                                          struct std::char_traits<char>,
                                                          class std::allocator<char>> const &a0,
                                  class Json::Value const &a1) {
        bool (ItemStackBase::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                          class std::allocator<char>> const &,
                                  class Json::Value const &);
        *((void **)&rv) = dlsym(
            "?updateComponent@ItemStackBase@@QEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@AEBVValue@Json@@@Z");
        return (this->*rv)(a0, a1);
    }
    ...
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        getDescriptionId() const {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            ItemStackBase::*rv)() const;
        *((void **)&rv) = dlsym(
            "?getDescriptionId@ItemStackBase@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$"
    ...
    MCINLINE void addCustomUserData(class BlockActor &a0, class BlockSource &a1) {
        ...
        *((void **)&rv) =
            dlsym("?addCustomUserData@ItemStackBase@@QEAAXAEAVBlockActor@@AEAVBlockSource@@@Z");
        return (this->*rv)(a0, a1);
    }
    ...
    MCINLINE class std::
        ...
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            ItemStackBase::*rv)() const;
        *((void **)&rv) = dlsym(
            "?getRawNameId@ItemStackBase@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@XZ");
        return (this->*rv)();
    ...
    MCINLINE bool addComponents(
        class Json::Value const &a0,
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
            &a1) {
        bool (ItemStackBase::*rv)(
            ...
            class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
                &);
        *((void **)&rv) = dlsym(
            "?addComponents@ItemStackBase@@QEAA_NAEBVValue@Json@@AEAV?$basic_string@DU?$char_"
    ...
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        _getHoverFormattingPrefix() const {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            ItemStackBase::*rv)() const;
        *((void **)&rv) = dlsym(
            "?_getHoverFormattingPrefix@ItemStackBase@@IEBA?AV?$basic_string@DU?$char_traits@D@std@"
            "@V?$allocator@D@2@@std@@XZ");
        return (this->*rv)();
    } MCINLINE bool hasComponent(
        ...
        bool (ItemStackBase::*rv)(class std::basic_string<char, struct std::char_traits<char>,
            ...
            const;
        *((void **)&rv) = dlsym(
            "?hasComponent@ItemStackBase@@QEBA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE class std::
        ...
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            ItemStackBase::*rv)() const;
        *((void **)&rv) = dlsym(
            "?getName@ItemStackBase@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@"
            "@std@@XZ");
        return (this->*rv)();
    } MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        ...
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            ItemStackBase::*rv)() const;
        *((void **)&rv) = dlsym(
            "?getHoverName@ItemStackBase@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@XZ");
        return (this->*rv)();
    } MCINLINE void setCustomLore(
        class std::vector<
            class std::
                basic_string<char, struct std::char_traits<char>, class std::allocator<char>>,
        ...
        void (ItemStackBase::*rv)(
            class std::vector<
                ...
                class std::allocator<class std::basic_string<char, struct std::char_traits<char>,
                                                             class std::allocator<char>>>> const &);
        *((void **)&rv) = dlsym(
            "?setCustomLore@ItemStackBase@@QEAAXAEBV?$vector@V?$basic_string@DU?$char_traits@D@std@"
            "@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$"
    ...
    MCINLINE class std::
        ...
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            ItemStackBase::*rv)() const;
        *((void **)&rv) = dlsym(
            "?getCustomName@ItemStackBase@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@XZ");
        return (this->*rv)();
    }
...
class ItemStack : public ItemStackBase {
  public:
    ...
    MCINLINE bool
    useOn(class Actor &a0, int a1, int a2, int a3, unsigned char a4, float a5, float a6, float a7) {
...
class Item {
  public:
    ...
    Item()                        = delete;
#ifdef MCAPI_ITEM_EXTRA
    MCINLINE class Item &setIcon(class std::basic_string<char,
                                                         struct std::char_traits<char>,
                                                         class std::allocator<char>> const &a0,
                                 int a1) {
        class Item &(Item::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                        class std::allocator<char>> const &,
                                int);
        *((void **)&rv) = dlsym(
            "?setIcon@Item@@UEAAAEAV1@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@"
            "std@@H@Z");
        return (this->*rv)(a0, a1);
    }
    MCINLINE bool inventoryTick(class ItemStack &a0,
                                class Level &a1,
                                class Actor &a2,
                                int a3,
                                bool a4) const {
        ...
        *((void **)&rv) =
            dlsym("?inventoryTick@Item@@UEBA_NAEAVItemStack@@AEAVLevel@@AEAVActor@@H_N@Z");
        return (this->*rv)(a0, a1, a2, a3, a4);
    }
    MCINLINE void _helpChangeInventoryItemInPlace(class Actor &a0,
                                                  class ItemStack &a1,
                                                  class ItemStack &a2,
                                                  enum ItemAcquisitionMethod a3) const {
        void (Item::*rv)(class Actor &, class ItemStack &, class ItemStack &,
                         enum ItemAcquisitionMethod) const;
        *((void **)&rv) = dlsym(
            "?_helpChangeInventoryItemInPlace@Item@@IEBAXAEAVActor@@AEAVItemStack@@"
            "1W4ItemAcquisitionMethod@@@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    ...
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        getSerializedName() const {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            Item::*rv)() const;
        *((void **)&rv) = dlsym(
            "?getSerializedName@Item@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@"
            "2@@std@@XZ");
        return (this->*rv)();
    } MCINLINE bool _useOn(class ItemInstance &a0,
                           class Actor &a1,
                           class BlockPos a2,
                           unsigned char a3,
                           float a4,
                           float a5,
                           float a6) const {
        bool (Item::*rv)(class ItemInstance &, class Actor &, class BlockPos, unsigned char, float,
                         float, float) const;
        *((void **)&rv) =
            dlsym("?_useOn@Item@@EEBA_NAEAVItemInstance@@AEAVActor@@VBlockPos@@EMMM@Z");
    ...
    MCINLINE bool useOn(class ItemStack &a0,
                        class Actor &a1,
                        int a2,
                        int a3,
                        int a4,
                        ...
                        float a7,
                        float a8) const {
        bool (Item::*rv)(class ItemStack &, class Actor &, int, int, int, unsigned char, float,
                         float, float) const;
    ...
    MCINLINE enum ItemUseMethod useTimeDepleted(class ItemInstance &a0,
                                                class Level *a1,
                                                class Player *a2) const {
        enum ItemUseMethod (Item::*rv)(class ItemInstance &, class Level *, class Player *) const;
        *((void **)&rv) = dlsym(
            "?useTimeDepleted@Item@@UEBA?AW4ItemUseMethod@@AEAVItemInstance@@PEAVLevel@@PEAVPlayer@"
            "@@Z");
        return (this->*rv)(a0, a1, a2);
    }
    ...
    MCINLINE enum ItemUseMethod useTimeDepleted(class ItemStack &a0,
                                                class Level *a1,
                                                class Player *a2) const {
        enum ItemUseMethod (Item::*rv)(class ItemStack &, class Level *, class Player *) const;
        *((void **)&rv) = dlsym(
            "?useTimeDepleted@Item@@UEBA?AW4ItemUseMethod@@AEAVItemStack@@PEAVLevel@@PEAVPlayer@@@"
            "Z");
        return (this->*rv)(a0, a1, a2);
    }
    ...
    MCINLINE bool mineBlock(class ItemStack &a0,
        ...
        bool (Item::*rv)(class ItemStack &, class Block const &, int, int, int, class Actor *)
            const;
        *((void **)&rv) =
            dlsym("?mineBlock@Item@@UEBA_NAEAVItemStack@@AEBVBlock@@HHHPEAVActor@@@Z");
    ...
    MCINLINE static void beginCreativeGroup(
        class std::
            basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const &a0,
        class Block const *a1,
        class CompoundTag const *a2) {
        return ((void (*)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &,
                          class Block const *, class CompoundTag const *))
                    dlsym("?beginCreativeGroup@Item@@SAXAEBV?$basic_string@DU?$char_traits@D@std@@"
                          "V?$allocator@D@2@@std@@PEBVBlock@@PEBVCompoundTag@@@Z"))(a0, a1, a2);
    }
    MCINLINE static void beginCreativeGroup(
        class std::
            basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const &a0,
        class ItemInstance const &a1) {
        return ((void (*)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &,
                          class ItemInstance const &))
                    dlsym("?beginCreativeGroup@Item@@SAXAEBV?$basic_string@DU?$char_traits@D@std@@"
                          "V?$allocator@D@2@@std@@AEBVItemInstance@@@Z"))(a0, a1);
    }
    ...
    MCINLINE void readAdditionalData(class ItemStackBase &a0, class CompoundTag const &a1) const {
        ...
        *((void **)&rv) =
            dlsym("?readAdditionalData@Item@@UEBAXAEAVItemStackBase@@AEBVCompoundTag@@@Z");
        return (this->*rv)(a0, a1);
    }
    ...
    MCINLINE int getAnimationFrameFor(class Mob *a0,
                                      bool a1,
    ...
    MCINLINE enum InHandUpdateType getInHandUpdateType(class Player const &a0,
                                                       class ItemInstance const &a1,
                                                       class ItemInstance const &a2,
                                                       bool a3,
                                                       bool a4) const {
        enum InHandUpdateType (Item::*rv)(class Player const &, class ItemInstance const &,
                                          class ItemInstance const &, bool, bool) const;
        *((void **)&rv) = dlsym(
            "?getInHandUpdateType@Item@@UEBA?AW4InHandUpdateType@@AEBVPlayer@@AEBVItemInstance@@1_"
            "N2@Z");
        return (this->*rv)(a0, a1, a2, a3, a4);
    }
    ...
    MCINLINE bool _calculatePlacePos(class ItemInstance &a0,
                                     class Actor &a1,
                                     unsigned char &a2,
                                     class BlockPos &a3) const {
        bool (Item::*rv)(class ItemInstance &, class Actor &, unsigned char &, class BlockPos &)
            const;
        *((void **)&rv) = dlsym(
            "?_calculatePlacePos@Item@@EEBA_NAEAVItemInstance@@AEAVActor@@AEAEAEAVBlockPos@@@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    MCINLINE static class TextureAtlasItem const &getTextureItem(
        class std::basic_string<char,
                                struct std::char_traits<char>,
                                class std::allocator<char>> const &a0) {
        return ((class TextureAtlasItem const
                     &(*)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &))
                    dlsym("?getTextureItem@Item@@SAAEBVTextureAtlasItem@@AEBV?$basic_string@DU?$"
                          "char_traits@D@std@@V?$allocator@D@2@@std@@@Z"))(a0);
    }
    ...
    MCINLINE bool _useOn(class ItemStack &a0,
                         class Actor &a1,
                         class BlockPos a2,
                         unsigned char a3,
                         float a4,
                         float a5,
                         float a6) const {
        bool (Item::*rv)(class ItemStack &, class Actor &, class BlockPos, unsigned char, float,
                         float, float) const;
    ...
    MCINLINE static struct TextureUVCoordinateSet const &
    getIconTextureUVSet(class TextureAtlasItem const &a0, int a1, int a2) {
        return ((struct TextureUVCoordinateSet const &(*)(class TextureAtlasItem const &, int, int))
                    dlsym("?getIconTextureUVSet@Item@@SAAEBUTextureUVCoordinateSet@@"
                          "AEBVTextureAtlasItem@@HH@Z"))(a0, a1, a2);
    }
    ...
    MCINLINE bool dispense(class BlockSource &a0,
        ...
        bool (Item::*rv)(class BlockSource &, class Container &, int, class Vec3 const &,
                         unsigned char) const;
        *((void **)&rv) =
            dlsym("?dispense@Item@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z");
        return (this->*rv)(a0, a1, a2, a3, a4);
    }
    MCINLINE static void addCreativeItem(class Block const &a0) {
        return ((void (*)(class Block const &))dlsym("?addCreativeItem@Item@@SAXAEBVBlock@@@Z"))(
            a0);
    }
    ...
    MCINLINE void saveAdditionalData(class ItemStackBase const &a0, class CompoundTag &a1) const {
        ...
        *((void **)&rv) =
            dlsym("?saveAdditionalData@Item@@UEBAXAEBVItemStackBase@@AEAVCompoundTag@@@Z");
        return (this->*rv)(a0, a1);
    }
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        buildDescriptionId(
            class ItemDescriptor const &a0,
            class std::unique_ptr<class CompoundTag,
                                  struct std::default_delete<class CompoundTag>> const &a1) const {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            Item::*rv)(
            class ItemDescriptor const &,
            class std::unique_ptr<class CompoundTag,
                                  struct std::default_delete<class CompoundTag>> const &) const;
        *((void **)&rv) = dlsym(
            "?buildDescriptionId@Item@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@"
            "2@@std@@AEBVItemDescriptor@@AEBV?$unique_ptr@VCompoundTag@@U?$default_delete@"
            "VCompoundTag@@@std@@@3@@Z");
        return (this->*rv)(a0, a1);
    ...
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        buildCategoryDescriptionName() const {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            Item::*rv)() const;
        *((void **)&rv) = dlsym(
            "?buildCategoryDescriptionName@Item@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@XZ");
        return (this->*rv)();
    ...
    MCINLINE class std::
        ...
        class std::basic_string<char,
                                struct std::char_traits<char>,
                                class std::allocator<char>> const &(Item::*rv)() const;
        *((void **)&rv) = dlsym(
            "?getCommandName@Item@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@"
            "std@@XZ");
        return (this->*rv)();
    } MCINLINE class Item &setIconAtlas(
        class std::
            basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const &a0,
        int a1) {
        class Item &(Item::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                ...
                                int);
        *((void **)&rv) = dlsym(
            "?setIconAtlas@Item@@UEAAAEAV1@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@"
            "D@2@@std@@H@Z");
        return (this->*rv)(a0, a1);
    }
    ...
    MCINLINE void readUserData(class ItemStackBase &a0,
                               class IDataInput &a1,
                               class ReadOnlyBinaryStream &a2) const {
        void (Item::*rv)(class ItemStackBase &, class IDataInput &, class ReadOnlyBinaryStream &)
            const;
        *((void **)&rv) = dlsym(
            "?readUserData@Item@@UEBAXAEAVItemStackBase@@AEAVIDataInput@@AEAVReadOnlyBinaryStream@@"
            "@Z");
        return (this->*rv)(a0, a1, a2);
    }
    ...
    MCINLINE static void beginCreativeGroup(
        ...
        short a1,
        short a2,
        class CompoundTag const *a3) {
        return ((void (*)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &,
                          short, short, class CompoundTag const *))
                    dlsym("?beginCreativeGroup@Item@@SAXAEBV?$basic_string@DU?$char_traits@D@std@@"
                          "V?$allocator@D@2@@std@@FFPEBVCompoundTag@@@Z"))(a0, a1, a2, a3);
    }
    ...
    MCINLINE class Item &setMinRequiredBaseGameVersion(class BaseGameVersion const &a0) {
        ...
        *((void **)&rv) =
            dlsym("?setMinRequiredBaseGameVersion@Item@@QEAAAEAV1@AEBVBaseGameVersion@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE static void addCreativeItem(class ItemInstance const &a0) {
        return ((void (*)(class ItemInstance const &))dlsym(
            "?addCreativeItem@Item@@SAXAEBVItemInstance@@@Z"))(a0);
    }
    ...
    MCINLINE bool _checkUseOnPermissions(class Actor &a0,
                                         class ItemInstance &a1,
                                         unsigned char const &a2,
                                         class BlockPos const &a3) const {
        bool (Item::*rv)(class Actor &, class ItemInstance &, unsigned char const &,
                         class BlockPos const &) const;
        *((void **)&rv) = dlsym(
            "?_checkUseOnPermissions@Item@@EEBA_NAEAVActor@@AEAVItemInstance@@AEBEAEBVBlockPos@@@"
            "Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    ...
    MCINLINE bool mineBlock(class ItemInstance &a0,
                            class Block const &a1,
                            int a2,
                            int a3,
                            int a4,
        ...
        bool (Item::*rv)(class ItemInstance &, class Block const &, int, int, int, class Actor *)
            const;
        *((void **)&rv) =
            dlsym("?mineBlock@Item@@UEBA_NAEAVItemInstance@@AEBVBlock@@HHHPEAVActor@@@Z");
        return (this->*rv)(a0, a1, a2, a3, a4, a5);
    }
    ...
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        buildDescriptionName(class ItemStackBase const &a0) const {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            Item::*rv)(class ItemStackBase const &) const;
        *((void **)&rv) = dlsym(
            "?buildDescriptionName@Item@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@"
            "D@2@@std@@AEBVItemStackBase@@@Z");
        return (this->*rv)(a0);
    ...
    MCINLINE struct TextureUVCoordinateSet const &getIcon(class ItemStackBase const &a0,
                                                          int a1,
                                                          bool a2) const {
        struct TextureUVCoordinateSet const &(Item::*rv)(class ItemStackBase const &, int, bool)
            const;
        *((void **)&rv) =
            dlsym("?getIcon@Item@@UEBAAEBUTextureUVCoordinateSet@@AEBVItemStackBase@@H_N@Z");
        return (this->*rv)(a0, a1, a2);
    }
    ...
    MCINLINE static void addCreativeItem(class Item *a0, short a1) {
        return ((void (*)(class Item *, short))dlsym("?addCreativeItem@Item@@SAXPEAV1@F@Z"))(a0,
                                                                                             a1);
    }
    ...
    MCINLINE enum InHandUpdateType getInHandUpdateType(class Player const &a0,
                                                       ...
                                                       bool a3,
                                                       bool a4) const {
        enum InHandUpdateType (Item::*rv)(class Player const &, class ItemStack const &,
                                          class ItemStack const &, bool, bool) const;
        *((void **)&rv) = dlsym(
            "?getInHandUpdateType@Item@@UEBA?AW4InHandUpdateType@@AEBVPlayer@@AEBVItemStack@@1_N2@"
            "Z");
        return (this->*rv)(a0, a1, a2, a3, a4);
    }
    MCINLINE bool isValidRepairItem(class ItemInstance const &a0,
                                    class ItemInstance const &a1) const {
    ...
    MCINLINE void appendFormattedHovertext(
        class ItemStackBase const &a0,
        class Level &a1,
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
            &a2,
        bool a3) const {
        void (Item::*rv)(
            class ItemStackBase const &, class Level &,
            class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
                &,
            bool) const;
        *((void **)&rv) = dlsym(
            "?appendFormattedHovertext@Item@@UEBAXAEBVItemStackBase@@AEAVLevel@@AEAV?$basic_string@"
            "DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_N@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        getAuxValuesDescription() const {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            Item::*rv)() const;
        *((void **)&rv) = dlsym(
            "?getAuxValuesDescription@Item@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@XZ");
        return (this->*rv)();
    ...
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        getInteractText(class Player const &a0) const {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            Item::*rv)(class Player const &) const;
        *((void **)&rv) = dlsym(
            "?getInteractText@Item@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@"
            "std@@AEBVPlayer@@@Z");
        return (this->*rv)(a0);
    ...
    MCINLINE short getDamageValue(
        class std::unique_ptr<class CompoundTag,
                              struct std::default_delete<class CompoundTag>> const &a0) const {
        short (Item::*rv)(
            class std::unique_ptr<class CompoundTag,
                                  struct std::default_delete<class CompoundTag>> const &) const;
        *((void **)&rv) = dlsym(
            "?getDamageValue@Item@@UEBAFAEBV?$unique_ptr@VCompoundTag@@U?$default_delete@"
            "VCompoundTag@@@std@@@std@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE static void beginCreativeGroup(
        ...
        return ((void (*)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &,
                          class Item *, short, class CompoundTag const *))
                    dlsym("?beginCreativeGroup@Item@@SAXAEBV?$basic_string@DU?$char_traits@D@std@@"
                          "V?$allocator@D@2@@std@@PEAV1@FPEBVCompoundTag@@@Z"))(a0, a1, a2, a3);
    }
    ...
    MCINLINE bool isWearableThroughLootTable(
        class std::unique_ptr<class CompoundTag,
                              struct std::default_delete<class CompoundTag>> const &a0) const {
        bool (Item::*rv)(
            class std::unique_ptr<class CompoundTag,
                                  struct std::default_delete<class CompoundTag>> const &) const;
        *((void **)&rv) = dlsym(
            "?isWearableThroughLootTable@Item@@UEBA_NAEBV?$unique_ptr@VCompoundTag@@U?$default_"
            "delete@VCompoundTag@@@std@@@std@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE bool _calculatePlacePos(class ItemStack &a0,
                                     class Actor &a1,
                                     unsigned char &a2,
                                     class BlockPos &a3) const {
        bool (Item::*rv)(class ItemStack &, class Actor &, unsigned char &, class BlockPos &) const;
        *((void **)&rv) =
            dlsym("?_calculatePlacePos@Item@@EEBA_NAEAVItemStack@@AEAVActor@@AEAEAEAVBlockPos@@@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    ...
    MCINLINE bool updateCustomBlockEntityTag(class BlockSource &a0,
                                             class ItemStack &a1,
                                             class BlockPos &a2) const {
        bool (Item::*rv)(class BlockSource &, class ItemStack &, class BlockPos &) const;
        *((void **)&rv) = dlsym(
            "?updateCustomBlockEntityTag@Item@@QEBA_NAEAVBlockSource@@AEAVItemStack@@AEAVBlockPos@@"
            "@Z");
        return (this->*rv)(a0, a1, a2);
    }
    MCINLINE void refreshedInContainer(class ItemStackBase &a0, class Level &a1) const {
        void (Item::*rv)(class ItemStackBase &, class Level &) const;
        *((void **)&rv) =
            dlsym("?refreshedInContainer@Item@@UEBAXAEAVItemStackBase@@AEAVLevel@@@Z");
        return (this->*rv)(a0, a1);
    }
    MCINLINE static void addCreativeItem(class ItemStack const &a0) {
        return ((void (*)(class ItemStack const &))dlsym(
            "?addCreativeItem@Item@@SAXAEBVItemStack@@@Z"))(a0);
    }
    ...
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        buildEffectDescriptionName(class ItemStackBase const &a0) const {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            Item::*rv)(class ItemStackBase const &) const;
        *((void **)&rv) = dlsym(
            "?buildEffectDescriptionName@Item@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@AEBVItemStackBase@@@Z");
        return (this->*rv)(a0);
    } MCINLINE bool _checkUseOnPermissions(class Actor &a0,
                                           class ItemStack &a1,
                                           unsigned char const &a2,
                                           class BlockPos const &a3) const {
        bool (Item::*rv)(class Actor &, class ItemStack &, unsigned char const &,
                         class BlockPos const &) const;
        *((void **)&rv) = dlsym(
            "?_checkUseOnPermissions@Item@@EEBA_NAEAVActor@@AEAVItemStack@@AEBEAEBVBlockPos@@@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
#endif
