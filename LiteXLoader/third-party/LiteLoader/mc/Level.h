...
class LevelStorage {
  public:
    ...
    loadAllPlayerIDs(bool a0) const {
        class std::vector<
            ...
            class std::allocator<class std::basic_string<char,
                                                         struct std::char_traits<char>,
                                                         class std::allocator<char>>>> (
            LevelStorage::*rv)(bool) const;
        *((void **)&rv) = dlsym(
            "?loadAllPlayerIDs@LevelStorage@@QEBA?AV?$vector@V?$basic_string@DU?$char_traits@D@std@"
            "@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@@2@@std@@_N@Z");
        return (this->*rv)(a0);
    ...
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        getServerId(class Player const &a0, bool a1) {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            LevelStorage::*rv)(class Player const &, bool);
        *((void **)&rv) = dlsym(
            "?getServerId@LevelStorage@@QEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@"
            "D@2@@std@@AEBVPlayer@@_N@Z");
...
class Level {
  public:
    ...
    Level()                         = delete;
#ifdef MCAPI_LEVEL_EXTRA
    MCINLINE void runCommand(class HashedString const &a0,
                             class CommandOrigin &a1,
                             enum CommandOriginSystem a2,
                             enum CurrentCmdVersion a3) {
        void (Level::*rv)(class HashedString const &, class CommandOrigin &,
                          enum CommandOriginSystem, enum CurrentCmdVersion);
        *((void **)&rv) = dlsym(
            "?runCommand@Level@@UEAAXAEBVHashedString@@AEAVCommandOrigin@@W4CommandOriginSystem@@"
            "W4CurrentCmdVersion@@@Z");
    ...
    MCINLINE void dropEntryFromTagCache(
        class std::basic_string<char,
                                struct std::char_traits<char>,
                                class std::allocator<char>> const &a0) {
        void (Level::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &);
        *((void **)&rv) = dlsym(
            "?dropEntryFromTagCache@Level@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE void playSound(class BlockSource &a0,
                            enum LevelSoundEvent a1,
                            class Vec3 const &a2,
                            int a3,
                            struct ActorDefinitionIdentifier const &a4,
                            bool a5,
                            bool a6) {
        void (Level::*rv)(class BlockSource &, enum LevelSoundEvent, class Vec3 const &, int,
                          struct ActorDefinitionIdentifier const &, bool, bool);
        *((void **)&rv) = dlsym(
            "?playSound@Level@@QEAAXAEAVBlockSource@@W4LevelSoundEvent@@AEBVVec3@@"
            "HAEBUActorDefinitionIdentifier@@_N4@Z");
    ...
    MCINLINE class ResourcePackManager *getServerResourcePackManager() const {
        ...
        *((void **)&rv) =
            dlsym("?getServerResourcePackManager@Level@@UEBAPEAVResourcePackManager@@XZ");
        return (this->*rv)();
    }
    ...
    MCINLINE class JigsawStructureRegistry &getJigsawStructureRegistry() {
        ...
        *((void **)&rv) =
            dlsym("?getJigsawStructureRegistry@Level@@UEAAAEAVJigsawStructureRegistry@@XZ");
        return (this->*rv)();
    }
    MCINLINE class JigsawStructureRegistry const &getJigsawStructureRegistry() const {
        ...
        *((void **)&rv) =
            dlsym("?getJigsawStructureRegistry@Level@@UEBAAEBVJigsawStructureRegistry@@XZ");
        return (this->*rv)();
    }
    ...
    MCINLINE class SurfaceBuilderRegistry &getSurfaceBuilderRegistry() {
        ...
        *((void **)&rv) =
            dlsym("?getSurfaceBuilderRegistry@Level@@UEAAAEAVSurfaceBuilderRegistry@@XZ");
        return (this->*rv)();
    }
    MCINLINE class SurfaceBuilderRegistry const &getSurfaceBuilderRegistry() const {
        ...
        *((void **)&rv) =
            dlsym("?getSurfaceBuilderRegistry@Level@@UEBAAEBVSurfaceBuilderRegistry@@XZ");
        return (this->*rv)();
    }
    ...
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>>
        _getValidatedPlayerName(class std::basic_string<char,
                                                        struct std::char_traits<char>,
                                                        class std::allocator<char>> const &a0) {
        class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (
            Level::*rv)(class std::basic_string<char,
                                                struct std::char_traits<char>,
                                                class std::allocator<char>> const &);
        *((void **)&rv) = dlsym(
            "?_getValidatedPlayerName@Level@@AEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@AEBV23@@Z");
        return (this->*rv)(a0);
    ...
    MCINLINE void addEntryToTagCache(
        class std::basic_string<char,
                                struct std::char_traits<char>,
                                class std::allocator<char>> const &a0) {
        void (Level::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &);
        *((void **)&rv) = dlsym(
            "?addEntryToTagCache@Level@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE void incrementTagCache(class std::basic_string<char,
                                                            struct std::char_traits<char>,
                                                            class std::allocator<char>> const &a0,
                                    class TagRegistry &a1) {
        void (Level::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &,
                          class TagRegistry &);
        *((void **)&rv) = dlsym(
            "?incrementTagCache@Level@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@"
            "D@2@@std@@AEAVTagRegistry@@@Z");
        return (this->*rv)(a0, a1);
    }
    ...
    MCINLINE void broadcastLevelEvent(enum LevelEvent a0,
                                      class Vec3 const &a1,
                                      int a2,
                                      class Player *a3) {
        void (Level::*rv)(enum LevelEvent, class Vec3 const &, int, class Player *);
        *((void **)&rv) =
            dlsym("?broadcastLevelEvent@Level@@QEAAXW4LevelEvent@@AEBVVec3@@HPEAVPlayer@@@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    ...
    MCINLINE bool checkAndHandleMaterial(class AABB const &a0,
                                         enum MaterialType a1,
                                         class Actor *a2) {
        bool (Level::*rv)(class AABB const &, enum MaterialType, class Actor *);
        *((void **)&rv) =
            dlsym("?checkAndHandleMaterial@Level@@QEAA_NAEBVAABB@@W4MaterialType@@PEAVActor@@@Z");
        return (this->*rv)(a0, a1, a2);
    }
    ...
    MCINLINE void broadcastLevelEvent(enum LevelEvent a0,
                                      class CompoundTag const &a1,
                                      class Player *a2) {
        void (Level::*rv)(enum LevelEvent, class CompoundTag const &, class Player *);
        *((void **)&rv) =
            dlsym("?broadcastLevelEvent@Level@@QEAAXW4LevelEvent@@AEBVCompoundTag@@PEAVPlayer@@@Z");
        return (this->*rv)(a0, a1, a2);
    }
    ...
    MCINLINE class std::
        ...
        getPlayerPlatformOnlineId(class mce::UUID const &a0) const {
        class std::
            basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const &(
                Level::*rv)(class mce::UUID const &) const;
        *((void **)&rv) = dlsym(
            "?getPlayerPlatformOnlineId@Level@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@AEBVUUID@mce@@@Z");
        return (this->*rv)(a0);
        ...
        *((void **)&rv) =
            dlsym("?_loadMapData@Level@@AEAAPEAVMapItemSavedData@@AEBUActorUniqueID@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE bool initialize(class std::basic_string<char,
                                                     struct std::char_traits<char>,
                                                     class std::allocator<char>> const &a0,
                             class LevelSettings const &a1,
                             class LevelData *a2,
                             class std::basic_string<char,
                                                     struct std::char_traits<char>,
                                                     class std::allocator<char>> const *a3) {
        bool (Level::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &,
                          class LevelSettings const &, class LevelData *,
                          class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const *);
        *((void **)&rv) = dlsym(
            "?initialize@Level@@UEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@"
            "std@@AEBVLevelSettings@@PEAVLevelData@@PEBV23@@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    MCINLINE void queueEntityRemoval(
        class std::unique_ptr<class Actor, struct std::default_delete<class Actor>> &&a0,
        bool a1) {
        void (Level::*rv)(
            class std::unique_ptr<class Actor, struct std::default_delete<class Actor>> &&, bool);
        *((void **)&rv) = dlsym(
            "?queueEntityRemoval@Level@@UEAAX$$QEAV?$unique_ptr@VActor@@U?$default_delete@VActor@@@"
            "std@@@std@@_N@Z");
    ...
    MCINLINE float getSpecialMultiplier(class AutomaticID<class Dimension, int> a0) {
        ...
        *((void **)&rv) =
            dlsym("?getSpecialMultiplier@Level@@QEAAMV?$AutomaticID@VDimension@@H@@@Z");
        return (this->*rv)(a0);
    }
    MCINLINE void decrementTagCache(class std::basic_string<char,
                                                            struct std::char_traits<char>,
                                                            class std::allocator<char>> const &a0,
                                    class TagRegistry &a1) {
        void (Level::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                          ...
                          class TagRegistry &);
        *((void **)&rv) = dlsym(
            "?decrementTagCache@Level@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@"
            "D@2@@std@@AEAVTagRegistry@@@Z");
        return (this->*rv)(a0, a1);
    }
    ...
    MCINLINE void entityChangeDimension(class Actor &a0,
        ...
        *((void **)&rv) =
            dlsym("?entityChangeDimension@Level@@QEAAXAEAVActor@@V?$AutomaticID@VDimension@@H@@@Z");
        return (this->*rv)(a0, a1);
    }
    MCINLINE class MapItemSavedData &createMapSavedData(struct ActorUniqueID const &a0,
                                                        class BlockPos const &a1,
                                                        class AutomaticID<class Dimension, int> a2,
                                                        int a3) {
        class MapItemSavedData &(Level::*rv)(struct ActorUniqueID const &, class BlockPos const &,
                                             class AutomaticID<class Dimension, int>, int);
        *((void **)&rv) = dlsym(
            "?createMapSavedData@Level@@QEAAAEAVMapItemSavedData@@AEBUActorUniqueID@@AEBVBlockPos@@"
            "V?$AutomaticID@VDimension@@H@@H@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    ...
    MCINLINE void broadcastDimensionEvent(class BlockSource &a0,
                                          enum LevelEvent a1,
                                          class Vec3 const &a2,
                                          int a3,
                                          class Player *a4) {
        void (Level::*rv)(class BlockSource &, enum LevelEvent, class Vec3 const &, int,
                          class Player *);
        *((void **)&rv) = dlsym(
            "?broadcastDimensionEvent@Level@@QEAAXAEAVBlockSource@@W4LevelEvent@@AEBVVec3@@"
            "HPEAVPlayer@@@Z");
    ...
    MCINLINE void broadcastSoundEvent(class BlockSource &a0,
                                      enum LevelSoundEvent a1,
                                      class Vec3 const &a2,
                                      int a3,
                                      struct ActorDefinitionIdentifier const &a4,
        ...
        void (Level::*rv)(class BlockSource &, enum LevelSoundEvent, class Vec3 const &, int,
                          struct ActorDefinitionIdentifier const &, bool, bool);
        *((void **)&rv) = dlsym(
            "?broadcastSoundEvent@Level@@QEAAXAEAVBlockSource@@W4LevelSoundEvent@@AEBVVec3@@"
            "HAEBUActorDefinitionIdentifier@@_N4@Z");
        return (this->*rv)(a0, a1, a2, a3, a4, a5, a6);
    }
    ...
    MCINLINE void spawnParticleEffect(class std::basic_string<char,
                                                              struct std::char_traits<char>,
                                                              class std::allocator<char>> const &a0,
                                      class Vec3 const &a1,
                                      class Dimension *a2) {
        void (Level::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                  class std::allocator<char>> const &,
                          class Vec3 const &, class Dimension *);
        *((void **)&rv) = dlsym(
            "?spawnParticleEffect@Level@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@AEBVVec3@@PEAVDimension@@@Z");
        return (this->*rv)(a0, a1, a2);
    }
    ...
    MCINLINE class ResourcePackManager *getClientResourcePackManager() const {
        class ResourcePackManager *(Level::*rv)() const;
        *((void **)&rv) =
            dlsym("?getClientResourcePackManager@Level@@UEBAPEAVResourcePackManager@@XZ");
        return (this->*rv)();
    }
    MCINLINE class std::
        basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const &
        getPlayerXUID(class mce::UUID const &a0) const {
        class std::
            basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const &(
                Level::*rv)(class mce::UUID const &) const;
        *((void **)&rv) = dlsym(
            "?getPlayerXUID@Level@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@"
            "std@@AEBVUUID@mce@@@Z");
        return (this->*rv)(a0);
    ...
    MCINLINE bool extinguishFire(class BlockSource &a0,
                                 class BlockPos const &a1,
                                 unsigned char a2) {
    ...
    MCINLINE class Particle *addParticle(enum ParticleType a0,
                                         class Vec3 const &a1,
                                         class Vec3 const &a2,
                                         int a3,
                                         class CompoundTag const *a4,
                                         bool a5) {
        class Particle *(Level::*rv)(enum ParticleType, class Vec3 const &, class Vec3 const &, int,
                                     class CompoundTag const *, bool);
        *((void **)&rv) = dlsym(
            "?addParticle@Level@@QEAAPEAVParticle@@W4ParticleType@@AEBVVec3@@1HPEBVCompoundTag@@_N@"
            "Z");
    ...
    MCINLINE void playSynchronizedSound(class BlockSource &a0,
                                        enum LevelSoundEvent a1,
                                        class Vec3 const &a2,
                                        int a3,
                                        struct ActorDefinitionIdentifier const &a4,
        ...
        void (Level::*rv)(class BlockSource &, enum LevelSoundEvent, class Vec3 const &, int,
                          struct ActorDefinitionIdentifier const &, bool, bool);
        *((void **)&rv) = dlsym(
            "?playSynchronizedSound@Level@@QEAAXAEAVBlockSource@@W4LevelSoundEvent@@AEBVVec3@@"
            "HAEBUActorDefinitionIdentifier@@_N4@Z");
        return (this->*rv)(a0, a1, a2, a3, a4, a5, a6);
    }
    ...
    MCINLINE class Dimension *getDimension(class AutomaticID<class Dimension, int> a0) const {
        ...
        *((void **)&rv) =
            dlsym("?getDimension@Level@@QEBAPEAVDimension@@V?$AutomaticID@VDimension@@H@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE class Dimension &createDimension(class AutomaticID<class Dimension, int> a0) {
        ...
        *((void **)&rv) =
            dlsym("?createDimension@Level@@QEAAAEAVDimension@@V?$AutomaticID@VDimension@@H@@@Z");
        return (this->*rv)(a0);
    }
    MCINLINE class BiomeComponentFactory &getBiomeComponentFactory() {
        class BiomeComponentFactory &(Level::*rv)();
        *((void **)&rv) =
            dlsym("?getBiomeComponentFactory@Level@@UEAAAEAVBiomeComponentFactory@@XZ");
        return (this->*rv)();
    }
    MCINLINE class BiomeComponentFactory const &getBiomeComponentFactory() const {
        ...
        *((void **)&rv) =
            dlsym("?getBiomeComponentFactory@Level@@UEBAAEBVBiomeComponentFactory@@XZ");
        return (this->*rv)();
    }
    MCINLINE void playSound(enum LevelSoundEvent a0,
                            class Vec3 const &a1,
                            int a2,
                            struct ActorDefinitionIdentifier const &a3,
                            bool a4,
                            bool a5) {
        void (Level::*rv)(enum LevelSoundEvent, class Vec3 const &, int,
                          struct ActorDefinitionIdentifier const &, bool, bool);
        *((void **)&rv) = dlsym(
            "?playSound@Level@@QEAAXW4LevelSoundEvent@@AEBVVec3@@HAEBUActorDefinitionIdentifier@@_"
            "N3@Z");
        return (this->*rv)(a0, a1, a2, a3, a4, a5);
    }
    ...
    MCINLINE class MapItemSavedData &_createMapSavedData(struct ActorUniqueID const &a0) {
        class MapItemSavedData &(Level::*rv)(struct ActorUniqueID const &);
        *((void **)&rv) =
            dlsym("?_createMapSavedData@Level@@AEAAAEAVMapItemSavedData@@AEBUActorUniqueID@@@Z");
        return (this->*rv)(a0);
    }

    MCINLINE void addTerrainParticleEffect(class BlockPos const &a0,
                                           class Block const &a1,
                                           class Vec3 const &a2,
                                           float a3,
                                           float a4,
                                           float a5) {
        void (Level::*rv)(class BlockPos const &, class Block const &, class Vec3 const &, float,
                          float, float);
        *((void **)&rv) =
            dlsym("?addTerrainParticleEffect@Level@@QEAAXAEBVBlockPos@@AEBVBlock@@AEBVVec3@@MMM@Z");
        return (this->*rv)(a0, a1, a2, a3, a4, a5);
    }
    MCINLINE void tick() {
        void (Level::*rv)();
    ...
    MCINLINE class MapItemSavedData *getMapSavedData(struct ActorUniqueID a0) {
        ...
        *((void **)&rv) =
            dlsym("?getMapSavedData@Level@@UEAAPEAVMapItemSavedData@@UActorUniqueID@@@Z");
        return (this->*rv)(a0);
    }
    ...
    MCINLINE void explode(class BlockSource &a0,
                          class Actor *a1,
                          class Vec3 const &a2,
                          float a3,
                          bool a4,
                          ...
                          float a6,
                          bool a7) {
        void (Level::*rv)(class BlockSource &, class Actor *, class Vec3 const &, float, bool, bool,
                          float, bool);
        *((void **)&rv) =
            dlsym("?explode@Level@@UEAAXAEAVBlockSource@@PEAVActor@@AEBVVec3@@M_N3M3@Z");
...
class ServerLevel : public Level {
  public:
    ...
    MCINLINE void incrementTagCache(class std::basic_string<char,
                                                            ...
                                                            class std::allocator<char>> const &a0,
                                    class TagRegistry &a1) {
        void (ServerLevel::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                        class std::allocator<char>> const &,
                                class TagRegistry &);
        *((void **)&rv) = dlsym(
            "?incrementTagCache@ServerLevel@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@AEAVTagRegistry@@@Z");
        return (this->*rv)(a0, a1);
    }
    MCINLINE void loadFunctionManager() {
        void (ServerLevel::*rv)();
    ...
    MCINLINE void dropEntryFromTagCache(
        ...
        void (ServerLevel::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                        class std::allocator<char>> const &);
        *((void **)&rv) = dlsym(
            "?dropEntryFromTagCache@ServerLevel@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@@Z");
        return (this->*rv)(a0);
    }
    MCINLINE void tick() {
    ...
    MCINLINE class ResourcePackManager *getClientResourcePackManager() const {
        ...
        *((void **)&rv) =
            dlsym("?getClientResourcePackManager@ServerLevel@@UEBAPEAVResourcePackManager@@XZ");
        return (this->*rv)();
    }
    MCINLINE void runCommand(class HashedString const &a0,
                             class CommandOrigin &a1,
                             enum CommandOriginSystem a2,
                             enum CurrentCmdVersion a3) {
        void (ServerLevel::*rv)(class HashedString const &, class CommandOrigin &,
                                enum CommandOriginSystem, enum CurrentCmdVersion);
        *((void **)&rv) = dlsym(
            "?runCommand@ServerLevel@@UEAAXAEBVHashedString@@AEAVCommandOrigin@@"
            "W4CommandOriginSystem@@W4CurrentCmdVersion@@@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    MCINLINE bool initialize(class std::basic_string<char,
                                                     struct std::char_traits<char>,
                             ...
                             class std::basic_string<char,
                                                     struct std::char_traits<char>,
                                                     class std::allocator<char>> const *a3) {
        bool (ServerLevel::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                        class std::allocator<char>> const &,
                                class LevelSettings const &, class LevelData *,
                                class std::basic_string<char, struct std::char_traits<char>,
                                                        class std::allocator<char>> const *);
        *((void **)&rv) = dlsym(
            "?initialize@ServerLevel@@UEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@"
            "D@2@@std@@AEBVLevelSettings@@PEAVLevelData@@PEBV23@@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    MCINLINE void saveAdditionalData() {
        void (ServerLevel::*rv)();
    ...
    MCINLINE class ResourcePackManager *getServerResourcePackManager() const {
        class ResourcePackManager *(ServerLevel::*rv)() const;
        *((void **)&rv) =
            dlsym("?getServerResourcePackManager@ServerLevel@@UEBAPEAVResourcePackManager@@XZ");
        return (this->*rv)();
    }
    ...
    MCINLINE class LevelEventCoordinator &getLevelEventCoordinator() {
        ...
        *((void **)&rv) =
            dlsym("?getLevelEventCoordinator@ServerLevel@@UEAAAEAVLevelEventCoordinator@@XZ");
        return (this->*rv)();
    }
    ...
    MCINLINE void _registerScoreboardCallbacks(class ServerScoreboard &a0) {
        ...
        *((void **)&rv) =
            dlsym("?_registerScoreboardCallbacks@ServerLevel@@IEAAXAEAVServerScoreboard@@@Z");
        return (this->*rv)(a0);
    }
    MCINLINE void decrementTagCache(class std::basic_string<char,
                                                            struct std::char_traits<char>,
        ...
        void (ServerLevel::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                ...
                                class TagRegistry &);
        *((void **)&rv) = dlsym(
            "?decrementTagCache@ServerLevel@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@AEAVTagRegistry@@@Z");
        return (this->*rv)(a0, a1);
    }
    MCINLINE void setWorldTemplateOptionsUnlocked() {
    ...
    MCINLINE void addEntryToTagCache(
        ...
        void (ServerLevel::*rv)(class std::basic_string<char, struct std::char_traits<char>,
                                                        class std::allocator<char>> const &);
        *((void **)&rv) = dlsym(
            "?addEntryToTagCache@ServerLevel@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$"
            "allocator@D@2@@std@@@Z");
        return (this->*rv)(a0);
    }
#endif
...
class ChunkSource {
  public:
    ...
    MCINLINE void _launchGenerationTask(class std::shared_ptr<class LevelChunk> &a0, bool a1) {
        ...
        *((void **)&rv) = dlsym(
            "?_launchGenerationTask@ChunkSource@@IEAAXAEAV?$shared_ptr@VLevelChunk@@@std@@_N@Z");
        return (this->*rv)(a0, a1);
    }
    ...
    MCINLINE void postProcessMobsAt(class BlockSource *a0, int a1, int a2, class Random &a3) {
        ...
        *((void **)&rv) =
            dlsym("?postProcessMobsAt@ChunkSource@@UEAAXPEAVBlockSource@@HHAEAVRandom@@@Z");
        return (this->*rv)(a0, a1, a2, a3);
    }
    ...
    MCINLINE class std::unordered_map<
        class ChunkPos,
        class std::weak_ptr<class LevelChunk>,
        struct std::hash<class ChunkPos>,
        struct std::equal_to<class ChunkPos>,
        class std::allocator<
            struct std::pair<class ChunkPos const, class std::weak_ptr<class LevelChunk>>>> const &
    getStorage() const {
        class std::unordered_map<
            ...
            struct std::hash<class ChunkPos>,
            struct std::equal_to<class ChunkPos>,
            class std::allocator<struct std::pair<class ChunkPos const,
                                                  class std::weak_ptr<class LevelChunk>>>> const
            &(ChunkSource::*rv)() const;
        *((void **)&rv) = dlsym(
            "?getStorage@ChunkSource@@UEBAAEBV?$unordered_map@VChunkPos@@V?$weak_ptr@VLevelChunk@@@"
            "std@@U?$hash@VChunkPos@@@3@U?$equal_to@VChunkPos@@@3@V?$allocator@U?$pair@$$"
            "CBVChunkPos@@V?$weak_ptr@VLevelChunk@@@std@@@std@@@3@@std@@XZ");
        return (this->*rv)();
    ...
    getChunkMap() {
        class std::unordered_map<
            ...
            *(ChunkSource::*rv)();
        *((void **)&rv) = dlsym(
            "?getChunkMap@ChunkSource@@UEAAPEBV?$unordered_map@VChunkPos@@V?$weak_ptr@VLevelChunk@@"
            "@std@@U?$hash@VChunkPos@@@3@U?$equal_to@VChunkPos@@@3@V?$allocator@U?$pair@$$"
            "CBVChunkPos@@V?$weak_ptr@VLevelChunk@@@std@@@std@@@3@@std@@XZ");
        return (this->*rv)();
    ...
    MCINLINE bool _checkAndDispatchTaskForLevelChunk(class ChunkPos const &a0, bool a1) {
        ...
        *((void **)&rv) =
            dlsym("?_checkAndDispatchTaskForLevelChunk@ChunkSource@@IEAA_NAEBVChunkPos@@_N@Z");
        return (this->*rv)(a0, a1);
    }
